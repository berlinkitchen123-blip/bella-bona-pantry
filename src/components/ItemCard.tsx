...
whileTap={{ scale: 0.8 }}
onClick={() => {}}
className="px-2 py-0.5 rounded-md text-[9px] font-black uppercase tracking-wider transition-colors flex items-center gap-1 bg-surface-50 text-surface-400 hover:text-red-500 hover:bg-red-50"
